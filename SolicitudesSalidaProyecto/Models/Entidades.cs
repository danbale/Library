namespace SolicitudesSalidaProyecto.Models
{
    using System;
    ...
    public partial class Entidades : DbContext
    {
        ...
        public virtual DbSet<Actividad_Asociada> Actividad_Asociada { get; set; }
        ...
        {
            modelBuilder.Entity<Actividad_Asociada>()
                .HasMany(e => e.Solicituds)
                .WithRequired(e => e.Actividad_Asociada)
